...
!function(t, e) {
    ...
    const n = class {
        ...
        updateParameters(t, e) {
            ...
            case h.EyeState_Closed:
                ...
                s >= 1 && (this._blinkingState = h.EyeState_Opening,
                this._stateStartTimeSeconds = this._userTimeSeconds),
                i = 0;
                break;
            ...
            case h.EyeState_Interval:
                this._nextBlinkingTime < this._userTimeSeconds && (this._blinkingState = h.EyeState_Closing,
                this._stateStartTimeSeconds = this._userTimeSeconds),
                i = 1;
                break;
    ...
    let l = n;
    l.CloseIfZero = !0;
    var h = (t => (t[t.EyeState_First = 0] = "EyeState_First",
    ...
    class C {
        static startUp(t) {
            if (v)
                return I("CubismFramework.startUp() is already done."),
                v;
            ...
            return I("CubismFramework.startUp() is complete."),
            v
        }
        static cleanUp() {
            v = !1,
        ...
        static initialize() {
            v ? M ? L("CubismFramework.initialize() skipped, already initialized.") : (M = !0,
            I("CubismFramework.initialize() is complete.")) : L("CubismFramework is not started.")
        }
        static dispose() {
            v ? M ? (_.staticRelease(),
            M = !1,
            I("CubismFramework.dispose() is complete.")) : L("CubismFramework.dispose() skipped, not initialized.") : L("CubismFramework is not started.")
        }
        static isStarted() {
            return v
        }
    ...
    class R {
        ...
        updateParameters(t, e, i) {
            ...
            let s = this._weight;
            s = s * (0 == this._fadeInSeconds ? 1 : g.getEasingSine((i - e.getFadeInStartTime()) / this._fadeInSeconds)) * (0 == this._fadeOutSeconds || e.getEndTime() < 0 ? 1 : g.getEasingSine((e.getEndTime() - i) / this._fadeOutSeconds)),
            e.setState(i, s),
    ...
    var k, U = (t => (t[t.ExpressionBlendType_Add = 0] = "ExpressionBlendType_Add",
    ...
    (k = t.CubismConfig || (t.CubismConfig = {})).supportMoreMaskDivisions = !0,
    k.setOpacityFromMotion = !1;
    var N = (t => (t[t.CubismMotionCurveTarget_Model = 0] = "CubismMotionCurveTarget_Model",
    ...
    t))(N || {})
      , V = (t => (t[t.CubismMotionSegmentType_Linear = 0] = "CubismMotionSegmentType_Linear",
    ...
    var Y = (t => (t[t.EvaluationOptionFlag_AreBeziersRistricted = 0] = "EvaluationOptionFlag_AreBeziersRistricted",
    t))(Y || {});
    function q(t, e, i) {
        const s = new j;
    ...
    function tt(t, e, i) {
        ...
        for (let l = s.baseSegmentIndex; l < a; ++l)
            if (o = t.segments[l].basePointIndex + (t.segments[l].segmentType == V.CubismMotionSegmentType_Bezier ? 3 : 1),
            t.points[o].time > i) {
                r = l;
                break
            }
    ...
    class et extends R {
        ...
        doUpdateParameters(e, i, s, r) {
            ...
            let h = 0
              , u = 0;
            this._eyeBlinkParameterIds.length > l && w("too many eye blink targets : {0}", this._eyeBlinkParameterIds.length),
            this._lipSyncParameterIds.length > l && w("too many lip sync targets : {0}", this._lipSyncParameterIds.length);
            ...
            let m, p, _, f = a;
            if (this._isLoop)
                for (; f > this._motionData.duration; )
                    f -= this._motionData.duration;
            const y = this._motionData.curves;
            for (p = 0; p < this._motionData.curveCount && y[p].type == N.CubismMotionCurveTarget_Model; ++p)
                m = tt(this._motionData, p, f),
                y[p].id == this._modelCurveIdEyeBlink ? n = m : y[p].id == this._modelCurveIdLipSync && (o = m);
            for (; p < this._motionData.curveCount && y[p].type == N.CubismMotionCurveTarget_Parameter; ++p) {
                if (_ = e.getParameterIndex(y[p].id),
                -1 == _)
                    continue;
                const t = e.getParameterValueByIndex(_);
                if (m = tt(this._motionData, p, f),
                n != Number.MAX_VALUE)
                ...
                let a;
                if (y[p].fadeInTime < 0 && y[p].fadeOutTime < 0)
                    a = t + (m - t) * s;
                else {
                    let e, s;
                    e = y[p].fadeInTime < 0 ? d : 0 == y[p].fadeInTime ? 1 : g.getEasingSine((i - r.getFadeInStartTime()) / y[p].fadeInTime),
                    s = y[p].fadeOutTime < 0 ? c : 0 == y[p].fadeOutTime || r.getEndTime() < 0 ? 1 : g.getEasingSine((r.getEndTime() - i) / y[p].fadeOutTime);
            ...
            a >= this._motionData.duration && (this._isLoop ? (r.setStartTime(i),
            this._isLoopFadeIn && r.setFadeInStartTime(i)) : (this._onFinishedMotion && this._onFinishedMotion(this),
            r.setIsFinished(!0))),
            this._lastWeight = s
        }
        setIsLoop(t) {
        ...
        parse(t) {
            ...
            for (let n = 0; n < this._motionData.curveCount; ++n) {
                ...
                for (let l = 0; l < e.getMotionCurveSegmentCount(n); ) {
                    ...
                    this._motionData.points[a] = new j(e.getMotionCurveSegment(n, l),e.getMotionCurveSegment(n, l + 1)),
                    a += 1,
                    ...
                    case V.CubismMotionSegmentType_Linear:
                        this._motionData.segments[o].segmentType = V.CubismMotionSegmentType_Linear,
                        this._motionData.segments[o].evaluate = $,
                        this._motionData.points[a] = new j(e.getMotionCurveSegment(n, l + 1),e.getMotionCurveSegment(n, l + 2)),
                        a += 1,
                        l += 3;
                        break;
                    case V.CubismMotionSegmentType_Bezier:
                        this._motionData.segments[o].segmentType = V.CubismMotionSegmentType_Bezier,
                        this._motionData.segments[o].evaluate = i ? Z : J,
                        this._motionData.points[a] = new j(e.getMotionCurveSegment(n, l + 1),e.getMotionCurveSegment(n, l + 2)),
                        this._motionData.points[a + 1] = new j(e.getMotionCurveSegment(n, l + 3),e.getMotionCurveSegment(n, l + 4)),
                        this._motionData.points[a + 2] = new j(e.getMotionCurveSegment(n, l + 5),e.getMotionCurveSegment(n, l + 6)),
                        a += 3,
                        l += 7;
                        break;
                    ...
                    case V.CubismMotionSegmentType_InverseStepped:
                        this._motionData.segments[o].segmentType = V.CubismMotionSegmentType_InverseStepped,
    ...
    const rt = -1;
    var at = (t => (t[t.CubismPhysicsTargetType_Parameter = 0] = "CubismPhysicsTargetType_Parameter",
    t))(at || {})
      , ot = (t => (t[t.CubismPhysicsSource_X = 0] = "CubismPhysicsSource_X",
        ...
        evaluate(t, e) {
            ...
            for (let f = 0; f < this._physicsRig.subRigCount; ++f) {
                ...
                for (let e = 0; e < n.inputCount; ++e)
                    ...
                    l[e].getNormalizedParameterValue(o, i, d[l[e].sourceParameterIndex], p[l[e].sourceParameterIndex], m[l[e].sourceParameterIndex], _[l[e].sourceParameterIndex], n.normalizationPosition, n.normalizationAngle, l[e].reflect, s);
                r = g.degreesToRadian(-i.angle),
                o.x = o.x * g.cos(r) - o.y * g.sin(r),
                o.y = o.x * g.sin(r) + o.y * g.cos(r),
                wt(u, n.particleCount, o, i.angle, this._options.wind, .001 * n.normalizationPosition.maximum, e, 5);
        ...
        initialize() {
            ...
            for (let s = 0; s < this._physicsRig.subRigCount; ++s) {
                ...
                for (let s = 1; s < e.particleCount; ++s)
                    i = new c(0,0),
                    i.y = t[s].radius,
                    t[s].initialPosition = new c(t[s - 1].initialPosition.x + i.x,t[s - 1].initialPosition.y + i.y),
    ...
    function wt(t, e, i, s, r, a, o, n) {
        let l, h, u, d, m = new c(0,0), p = new c(0,0), _ = new c(0,0), f = new c(0,0);
        ...
        for (let y = 1; y < e; ++y)
            ...
            0 != h && (t[y].velocity = t[y].position.substract(t[y].lastPosition),
            ...
            if (i > 0) {
                ...
                for (let i = 0; i < this._clippingContextListForMask.length; i++) {
                    ...
                    for (let i = 0; i < h; i++) {
                        ...
                        e.drawMesh(t.getDrawableTextureIndices(r), t.getDrawableVertexIndexCount(r), t.getDrawableVertexCount(r), t.getDrawableVertexIndices(r), t.getDrawableVertices(r), t.getDrawableVertexUvs(r), t.getDrawableOpacity(r), f.CubismBlendMode_Normal, !1))
                    }
                }
                this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Ft),
            ...
            for (let a = 0; a < 4; a++) {
                ...
                if (0 == e)
                    ...
                    for (let t = 0; t < e; t++) {
                        ...
                        s._layoutBounds.x = .5 * e,
                        s._layoutBounds.y = .5 * i,
                        s._layoutBounds.width = .5,
                        s._layoutBounds.height = .5
                    }
                else if (e <= 9)
                    for (let t = 0; t < e; t++) {
                        let e = t % 3
                    ...
                    T("not supported mask count : {0}", e)
            }
        }
        getColorBuffer() {
    ...
    class Ot {
        ...
        setupShaderProgram(t, e, i, s, r, a, o, n, l, h, u, d, c) {
            ...
            if (null != y) {
                ...
                this.gl.uniformMatrix4fv(t.uniformClipMatrixLocation, !1, y._matrixForMask.getArray());
        ...
        loadShaderProgram(t, e) {
            ...
            if (!s)
                return T("Vertex shader compile error!"),
                0;
            ...
            i) : (T("Failed to link program: {0}", i),
    ...
    class Wt extends _ {
        ...
        drawMesh(t, e, i, s, r, a, o, n, l) {
            ...
            Ot.getInstance().setupShaderProgram(this, u, i, r, s, a, this._bufferData, o, n, h, this.isPremultipliedAlpha(), this.getMvpMatrix(), l),
        ...
        loadExpression(t) {
            return __async(this, null, (function*() {
                ...
                if (null === this.expressions[t])
                    return void ee.warn(this.tag, `Cannot set expression at [${t}] because it's already failed in loading.`);
    ...
    class ue {
        ...
        reserve(t, e, i) {
            if (i <= 0)
                return ee.log(this.tag, "Cannot start a motion with MotionPriority.NONE."),
                !1;
            if (t === this.currentGroup && e === this.currentIndex)
                return ee.log(this.tag, "Motion is already playing.", this.dump(t, e)),
                !1;
            if (t === this.reservedGroup && e === this.reservedIndex || t === this.reservedIdleGroup && e === this.reservedIdleIndex)
                return ee.log(this.tag, "Motion is already reserved.", this.dump(t, e)),
                !1;
            if (1 === i) {
                if (0 !== this.currentPriority)
                    return ee.log(this.tag, "Cannot start idle motion because another motion is playing.", this.dump(t, e)),
                    !1;
                if (void 0 !== this.reservedIdleGroup)
                    return ee.log(this.tag, "Cannot start idle motion because another idle motion has reserved.", this.dump(t, e)),
                    !1;
                this.setReservedIdle(t, e)
            } else {
                if (i < 3) {
                    if (i <= this.currentPriority)
                        return ee.log(this.tag, "Cannot start motion because another motion is playing as an equivalent or higher priority.", this.dump(t, e)),
                        !1;
                    if (i <= this.reservePriority)
                        return ee.log(this.tag, "Cannot start motion because another motion has reserved as an equivalent or higher priority.", this.dump(t, e)),
                        !1
                }
        ...
        start(t, e, i, s) {
            if (1 === s) {
                ...
                0 !== this.currentPriority)
                    return ee.log(this.tag, "Cannot start idle motion because another motion is playing.", this.dump(e, i)),
                    !1
            } else {
                if (e !== this.reservedGroup || i !== this.reservedIndex)
                    return ee.log(this.tag, "Cannot start motion because another motion has taken the place.", this.dump(e, i)),
                    !1;
    ...
    class me extends e.EventEmitter {
        ...
        loadMotion(t, e) {
            return __async(this, null, (function*() {
                ...
                if (null === this.motionGroups[t][e])
                    return void ee.warn(this.tag, `Cannot start motion at "${t}"[${e}] because it's already failed in loading.`);
        ...
        startMotion(e, i) {
            return __async(this, arguments, (function*(e, i, s=he.NORMAL) {
                ...
                if (!a)
                    return !1;
                let o;
                if (this.currentAudio && de.dispose(this.currentAudio),
                t.config.sound) {
                    const t = this.getSoundFile(a);
                    if (t)
                        try {
                            o = de.add(this.settings.resolveURL(t), ( () => this.currentAudio = void 0), ( () => this.currentAudio = void 0)),
                            this.currentAudio = o
                        } catch (l) {
                ...
                return this.state.start(n, e, i, s) ? (ee.log(this.tag, "Start motion:", this.getMotionName(a)),
        ...
        stopAllMotions() {
            ...
            this.state.reset(),
            this.currentAudio && (de.dispose(this.currentAudio),
            this.currentAudio = void 0)
        }
        update(t, e) {
            var i;
            ...
            this.state.complete(),
            this.state.shouldRequestIdleMotion() && this.startRandomMotion(this.groups.idle, he.IDLE)),
    ...
    const fe = class {
        static createXHR(t, e, i, s, r) {
            ...
            if (fe.allXhrSet.add(a),
            t) {
                let e = fe.xhrMap.get(t);
                e ? e.add(a) : (e = new Set([a]),
                fe.xhrMap.set(t, e)),
                t.listeners("destroy").includes(fe.cancelXHRs) || t.once("destroy", fe.cancelXHRs)
            }
            return a.open("GET", e),
            a.responseType = i,
            a.onload = () => {
            ...
            ,
            a.onerror = () => {
                ee.warn("XHRLoader", `Failed to load resource as ${a.responseType} (Status ${a.status}): ${e}`),
    ...
    const Me = "Live2DFactory"
      ...
      , Le = class {
        static registerRuntime(t) {
            Le.runtimes.push(t),
            Le.runtimes.sort(( (t, e) => e.version - t.version))
        }
    ...
    class Ee {
        ...
        set autoInteract(t) {
            t !== this._autoInteract && (t ? this.on("pointertap", De, this) : this.off("pointertap", De, this),
        ...
        registerInteraction(t) {
            ...
            t.on("pointermove", Fe, this)))
        }
        unregisterInteraction() {
            var t;
            this.interactionManager && (null == (t = this.interactionManager) || t.off("pointermove", Fe, this),
    ...
    class ke extends r.Container {
        ...
        static fromSync(t, e) {
            const i = new this(e);
            return Te.setupLive2DModel(i, t, e).then(null == e ? void 0 : e.onLoad).catch(null == e ? void 0 : e.onError),
            i
        }
        ...
        set autoUpdate(t) {
            ...
            t ? this._destroyed || (Oe ? (Oe.shared.add(this.onTickerUpdate, this),
            this._autoUpdate = !0) : ee.warn(this.tag, "No Ticker registered, please call Live2DModel.registerTicker(Ticker).")) : (null == Oe || Oe.shared.remove(this.onTickerUpdate, this),
            this._autoUpdate = !1)
        }
        init(t) {
        ...
        tap(t, e) {
            ...
            i.length && (ee.log(this.tag, "Hit", i),
            this.emit("hit", i))
        }
        hitTest(t, e) {
            return Be.x = t,
    ...
    let Ne = Ue;
    Ne.filesMap = {},
    Ne.factory = (t, e) => __async(this, null, (function*() {
    ...
    ;
    let je = Ve;
    if (je.ZIP_PROTOCOL = "zip://",
    je.uid = 0,
    je.factory = (t, e) => __async(this, null, (function*() {
        const i = t.source;
        let s, r, a;
        if ("string" == typeof i && (i.endsWith(".zip") || i.startsWith(Ve.ZIP_PROTOCOL)) ? (s = i.startsWith(Ve.ZIP_PROTOCOL) ? i.slice(Ve.ZIP_PROTOCOL.length) : i,
        r = yield ve.load({
            url: s,
            type: "blob",
            target: t.live2dModel
    ...
    class ze extends me {
        ...
        init(t) {
            super.init(t),
            this.settings.expressions && (this.expressionManager = new Ge(this.settings,t)),
    ...
    class He extends pe {
        ...
        init() {
            var t;
            super.init(),
            (null == (t = this.settings.getEyeBlinkParameters()) ? void 0 : t.length) > 0 && (this.eyeBlink = l.create(this.settings)),
            this.breath.setParameters([new o(this.idParamAngleX,0,15,6.5345,.5), new o(this.idParamAngleY,0,8,3.5345,.5), new o(this.idParamAngleZ,0,10,5.5345,.5), new o(this.idParamBodyAngleX,0,4,15.5345,.5), new o(this.idParamBreath,0,.5,3.2345,.5)]),
    ...
    t.CubismMotionManager = class extends st {
        ...
        reserveMotion(t) {
            return !(t <= this._reservePriority || t <= this._currentPriority) && (this._reservePriority = t,
            !0)
        }
    }
    ,
